...
## 请按以下格式返回 JSON：
{
  ...
  "criticalFactors": [
    "针对这个具体事务，列出1-3个导致需要/不需要 DJ 的关键原因",
    "每个因素必须说明：为什么这个事务的这个特点需要/不需要 DJ 的特定能力",
    "避免使用通用评估维度（如'设计创新'、'用户体验'），要具体到事务本身"
  ]
}

## criticalFactors 示例：
好的示例（针对具体事务）：
- "涉及公司层面的战略资源承诺，需要董事长权限才能决策"
- "需要跨部门协调5个以上团队，只有 DJ 能推动"
- "属于日常运营数据分析，设计团队有能力独立完成"
